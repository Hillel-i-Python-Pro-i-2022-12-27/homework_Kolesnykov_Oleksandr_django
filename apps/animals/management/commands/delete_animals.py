...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument("--is-only-auto-generated", help="Delete only autogenerated animals", action="store_true")

    def handle(self, *args, **options):
        is_only_auto_generated = options["is_only_auto_generated"]
